...
We use `git <http://git-scm.com>`_ to manage and distribute source code.  Download InterMine software from :doc:`/git/index` and dependences from  :doc:`/docs/system-requirements/index`.
