...
You are able to get code in a number of languages. To access this, click on the "Get Code" button, which will present you with the different languages available. The javascript option enables you to embed the result table in the form you see it in any other page.

The html code produced can be used as a standalone page, or as a template to extract the relevant parts from for insertion into other pages.
